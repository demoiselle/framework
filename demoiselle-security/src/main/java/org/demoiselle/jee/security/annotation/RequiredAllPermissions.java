 ...
 * all of the specified permissions (AND logic) in order to be invoked.
 * Each permission is defined as a {@link Permission} with a resource and operation pair.
 * </p>
 *
 * @see Permission
...
@Target({METHOD, TYPE})
@Retention(RUNTIME)
public @interface RequiredAllPermissions {
