 ...
 *
 */
class ArrayExtractorTest extends AbstractConfigurationTest {

    private ConfigurationArrayValueExtractor conf = new ConfigurationArrayValueExtractor();
    private ConfigModel configModel = new ConfigModel();

    @Test
    void extractArrayFromProperties() throws Exception {
    ...
    @Test
    void extractArrayFromXML() throws Exception {
    ...
    @Test
    void extractorShouldBeSupportArray() throws NoSuchFieldException, SecurityException {
