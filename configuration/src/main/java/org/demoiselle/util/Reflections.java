...
public class Reflections {
    ...
    /**
     * Return the parametized type used with a concrete implementation of a
     * class that accepts generics. Ex: If you declare
     * <pre>
     * public class SpecializedCollection implements Collection&#60;SpecializedType&#62; {
     *   // ...
     * }
     * </pre> then the code
     * <code>getGenericTypeArgument(SpecializedCollection.class , 0);</code>
     * will return the type <code>SpecializedType</code>.
     *
     ...
     * </code>
     * </pre> then the code
     * <code>getGenericTypeArgument( MyClass.class.getDeclaredField("myStringCollection") , 0);</code>
    ...
    /**
     * <p>
     * Return the parametized type passed to members (fields or methods) that
     * accepts Generics.
     * </p>
     *
     ...
     * @return All non static fields from a certain type. Inherited fields are
     * not returned, so if you need to get inherited fields you must iterate
     * over this type's hierarchy.
     */
    ...
    /**
     * @param type Base type to look for fields
     * @return All non static fields from a certain type, including fields
     * declared in superclasses of this type.
     */
     ...
     * @return {@link Boolean} true if the given class can be converted to a
    ...
    /**
     * Obtains the {@link ClassLoader} for the given class, from his canonical
     * name.
     *
     ...
     *
     * @param resource String representation of the fully qualified path to the
    ...
    /**
     * Return an URL to access a resource available to the active classloader
     * for the calling thread.
     *
     * @param resource String representation of the location of the resource on
     * the classpath
    ...
    /**
     * Return an InputStream to access a resource available to the active
     * classloader for the calling thread.
     *
     * @param resource String representation of the location of the resource on
     * the classpath
    ...
    /**
     * Loads a class with the given name using the active classloader for the
     * current thread.
     *
     * @param className String with fully qualified class name of the desired
     * class
