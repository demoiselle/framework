...
public class CorsFilter implements ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext req, ContainerResponseContext res) throws IOException {
        ...
        config.getParamsHeaderSecuriry().forEach((key, value) -> res.getHeaders().putSingle(key, value));
        ...
        if (allowedOrigins == null || allowedOrigins.isEmpty()) {
            config.getParamsHeaderCors().forEach((key, value) -> res.getHeaders().putSingle(key, value));
            return;
        }

        String origin = req.getHeaderString("Origin");
        String resolvedOrigin = resolveAllowedOrigin(origin, allowedOrigins, config.isCorsAllowCredentials());
    ...
    private void applyCorsHeaders(ContainerResponseContext res, String origin, String resolvedOrigin) {
        ...
        res.getHeaders().putSingle("Access-Control-Max-Age", String.valueOf(config.getCorsMaxAge()));
    }
    ...
    private String resolveAllowedOrigin(String origin, List<String> allowedOrigins, boolean allowCredentials) {
