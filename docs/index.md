  ...
  <div class="shell hero-grid">
    <div class="hero-copy reveal-target">
      ...
      <div class="hero-actions">
        ...
        <a class="button button-secondary" href="{{ site.github_url }}">Explorar no GitHub <span aria-hidden="true">↗</span></a>
      </div>
  ...
  <div class="shell">
    ...
    <div class="value-grid">
      <article class="value-card reveal-target">
        <span class="card-number">01</span><span class="card-icon" aria-hidden="true">⌁</span>
      ...
      <article class="value-card reveal-target">
        <span class="card-number">02</span><span class="card-icon" aria-hidden="true">↔</span>
      ...
      <article class="value-card reveal-target">
        <span class="card-number">03</span><span class="card-icon" aria-hidden="true">◇</span>
      ...
      <article class="value-card reveal-target">
        <span class="card-number">04</span><span class="card-icon" aria-hidden="true">∞</span>
      ...
      <article class="value-card reveal-target">
        <span class="card-number">05</span><span class="card-icon" aria-hidden="true">◉</span>
      ...
      <article class="value-card reveal-target">
        <span class="card-number">06</span><span class="card-icon" aria-hidden="true">✓</span>
...
<section class="section capabilities-section" id="capacidades" aria-labelledby="capabilities-title">
  <div class="shell">
    ...
    <div class="bento-grid">
      <article class="bento-card bento-wide accent-teal reveal-target">
        <div class="bento-icon" aria-hidden="true">{ }</div><p class="card-overline">CRUD & JPA 3.1</p>
      ...
      <article class="bento-card bento-tall accent-blue reveal-target">
        <div class="bento-icon" aria-hidden="true">⌾</div><p class="card-overline">Segurança</p>
      ...
      <article class="bento-card accent-amber reveal-target">
        <div class="bento-icon" aria-hidden="true">↗</div><p class="card-overline">REST & OpenAPI</p>
      ...
      <article class="bento-card accent-violet reveal-target">
        <div class="bento-icon" aria-hidden="true">⚙</div><p class="card-overline">Configuração & segredos</p>
      ...
      <article class="bento-card bento-wide accent-blue reveal-target">
        <div class="bento-icon" aria-hidden="true">◎</div><p class="card-overline">Consistência</p>
      ...
      <article class="bento-card accent-teal reveal-target">
        <div class="bento-icon" aria-hidden="true">⌁</div><p class="card-overline">Observabilidade</p>
      ...
      <article class="bento-card accent-violet reveal-target">
        <div class="bento-icon" aria-hidden="true">✦</div><p class="card-overline">MCP</p>
      ...
      <article class="bento-card accent-amber reveal-target">
        <div class="bento-icon" aria-hidden="true">▦</div><p class="card-overline">Supply chain</p>
...
<section class="section architecture-section" id="arquitetura" aria-labelledby="architecture-title">
  <div class="shell">
    ...
    <aside class="portability-note reveal-target">
      <div><span class="note-icon" aria-hidden="true">i</span><div><strong>Portabilidade sem promessa vazia</strong><p>WildFly 27+, Open Liberty 23.x e Quarkus 3.x são alvos declarados. Cada produto deve certificar em CI o runtime e a configuração que realmente opera.</p></div></div>
...
<section class="section docs-section" aria-labelledby="docs-title">
  <div class="shell">
    ...
    <div class="docs-card-grid">
      <a class="docs-card reveal-target" href="{{ '/docs/' | relative_url }}"><span class="docs-card-icon" aria-hidden="true">01</span><div><strong>Guia técnico</strong><p>Funcionalidades, configuração e exemplos dos módulos.</p></div><span aria-hidden="true">→</span></a>
      <a class="docs-card reveal-target" href="{{ '/docs/migration-4.1.html' | relative_url }}"><span class="docs-card-icon" aria-hidden="true">02</span><div><strong>Migração 4.1</strong><p>Compatibilidade, defaults e contratos alterados.</p></div><span aria-hidden="true">→</span></a>
      <a class="docs-card reveal-target" href="{{ '/docs/production-extensions.html' | relative_url }}"><span class="docs-card-icon" aria-hidden="true">03</span><div><strong>Extensões de produção</strong><p>Benefícios e critérios para os seis adapters operacionais.</p></div><span aria-hidden="true">→</span></a>
      <a class="docs-card reveal-target" href="{{ '/docs/roadmap.html' | relative_url }}"><span class="docs-card-icon" aria-hidden="true">04</span><div><strong>Roadmap entregue</strong><p>Auditoria, implementação e invariantes do ciclo.</p></div><span aria-hidden="true">→</span></a>
    </div>
  </div>
</section>
  ...
  <div class="shell">
    ...
    <div class="ecosystem-grid">
      <article class="ecosystem-card ecosystem-featured reveal-target">
        <div class="ecosystem-card-top"><span class="ecosystem-symbol" aria-hidden="true">D4</span><span class="status-pill status-current">Ciclo atual</span></div>
      ...
      <article class="ecosystem-card reveal-target">
        <div class="ecosystem-card-top"><span class="ecosystem-symbol" aria-hidden="true">DS</span><span class="status-pill status-active">Projeto independente</span></div>
        ...
        <a class="text-link" href="https://github.com/demoiselle/signer">Ver projeto Signer <span aria-hidden="true">↗</span></a>
      </article>

      <article class="ecosystem-card reveal-target">
        <div class="ecosystem-card-top"><span class="ecosystem-symbol" aria-hidden="true">DB</span><span class="status-pill status-legacy">Legado / referência</span></div>
        ...
        <a class="text-link" href="https://github.com/demoiselle/behave">Consultar repositório <span aria-hidden="true">↗</span></a>
      </article>
    </div>
    ...
    <div class="legacy-links reveal-target">
      ...
      <div><a href="https://www.frameworkdemoiselle.gov.br/v3/jee7/index.html">Portal Demoiselle V3 <span aria-hidden="true">↗</span></a><a href="https://demoiselle.gitbooks.io/documentacao-jee/content">Documentação legada <span aria-hidden="true">↗</span></a><a href="https://www.frameworkdemoiselle.gov.br/">Portal institucional <span aria-hidden="true">↗</span></a></div>
    </div>

    <aside class="community-panel reveal-target" id="comunidade">
      <div><span class="community-mark" aria-hidden="true">&lt;/&gt;</span><div><p class="eyebrow">Comunidade</p><h3>Software livre cresce com colaboração.</h3><p>Discuta melhorias, relate problemas e acompanhe os demais projetos da organização Demoiselle no GitHub.</p></div></div>
