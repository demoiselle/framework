...
public abstract class AbstractDAO<T, I> implements Crud<T, I> {
    ...
    public T persist(T entity) {
        try {        	
        	Object pkValue = ((Object) getEntityManager().getEntityManagerFactory().getPersistenceUnitUtil().getIdentifier(entity));
         	...
         	if( isAutoGenerated ){         		         	    	         		
         		if( pkValue != null )
         			throw new DemoiselleCrudException("Não foi possível persistir entidade, chave primária definida!");            	        	            	              		         		
         	}else{
         		if( pkValue == null)
         			throw new DemoiselleCrudException("Não foi possível persistir entidade, chave primária indefinida!");
         	}
