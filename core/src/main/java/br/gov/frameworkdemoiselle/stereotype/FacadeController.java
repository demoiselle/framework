...
/**
 * Identifies a <b>facade</b> class. A facade is an object that provides a simplified interface to a larger body of
 * code, such as a class library.
 * <p>
 * A <i>Facade</i> is:
 * <ul>
 * <li>defined when annotated with {@code @Facade}</li>
