 ...
 */
package security.athentication.selection;
...
public class SelectedAuthenticatorTest {

	private static final String PATH = "src/test/resources/security/authenticator/selection";
	...
	public static JavaArchive createDeployment() {
		...
		deployment.addClass(DuplicatedCustomAuthenticator.class);
