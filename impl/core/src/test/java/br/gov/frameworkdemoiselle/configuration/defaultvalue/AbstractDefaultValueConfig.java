...
public abstract class AbstractDefaultValueConfig {
	...
	public String getStringDefaultWithKey() {
		return stringDefaultWithKey;
	}

	public void setStringDefaultWithoutKey(String stringDefaultWithoutKey) {
		this.stringDefaultWithoutKey = stringDefaultWithoutKey;
	}

	public void setStringDefaultWithKey(String stringDefaultWithKey) {
		this.stringDefaultWithKey = stringDefaultWithKey;
	}
}
