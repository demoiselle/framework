 ...
 * de chaves assimétricas. As chaves podem ser geradas por você no linux
 * https://help.ubuntu.com/community/SSH/OpenSSH/Keys ou deixar os parâmetros em
 * branco e ver no log as chaves sugeridas O padrão JWT é um dos mais seguros e
 * performaticos da atualidade, para saber mais consulte https://jwt.io/
 * <p>
...
public class TokensManagerImpl implements TokensManager {
    ...
    /**
     * Inicia as chaves que estão no arquivo demoiselle-security-jwt.properties
     * que deve estar no resource do seu projeto
     * <p>
