...
class ConfigTest {
    ...
    void testGetPrivateKey() {
        ...
        assertEquals(expResult, instance.getPrivateKey());
    }
    ...
    void testGetPublicKey() {
        ...
        assertEquals(expResult, instance.getPublicKey());
    }

    @Test
    void testGetTimetoLiveMilliseconds() {
        assertEquals(valueOf("9999999999"), instance.getTimetoLiveMilliseconds());
    }

    @Test
    void testGetIssuer() {
        assertEquals("STORE", instance.getIssuer());
    }

    @Test
    void testGetAudience() {
        assertEquals("web", instance.getAudience());
    }
