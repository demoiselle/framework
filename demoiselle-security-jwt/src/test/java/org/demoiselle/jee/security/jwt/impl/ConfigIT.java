...
public class ConfigIT {
    ...
    public void testGetTempo() {
        ...
        Float expResult = Float.valueOf("720");
    ...
    public void testGetRemetente() {
        System.out.println("getRemetente");
    ...
    public void testSetRemetente() {
        System.out.println("setRemetente");
