...
import org.demoiselle.jee.security.jwt.impl.*;
 ...
 * @author SERPRO
 */
@Configuration(prefix = "demoiselle.security.jwt", resource = "demoiselle")
public class DemoiselleSecurityJWTMock implements Serializable {
